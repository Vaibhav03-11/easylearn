...
export default function ComplexityCard({ info }: Props) {
        ...
        <div className="bg-white p-5 rounded-xl border border-gray-100 shadow-sm">
          ...
          <div className="space-y-3 text-sm">
            ...
            <div className="flex justify-between border-b pb-2">
              ...
              <span className="font-medium text-gray-800">{info.stability ? 'Yes' : 'No'}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-500">In-place</span>
              <span className="font-medium text-gray-800">{info.inPlace ? 'Yes' : 'No'}</span>
            </div>
          </div>
        </div>
